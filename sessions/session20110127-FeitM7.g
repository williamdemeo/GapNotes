...
#                   H
#
# All K's have block sizes:
Order(K23)/Order(H);  # 64512
# All K's have this many blocks:
Index(a31,H)/(Order(K23)/Order(H)); # 411168247476734651904000000
# N has block size:
Order(N)/Order(H);  # 3
# N has this many blocks:
Index(a31,H)/(Order(N)/Order(H));  # 8841761993739701954543616000000
 
IsSubgroup(a31,K11);        # true
IsSubgroup(a31,K12);        # true
IsSubgroup(a31,K21);        # true
IsSubgroup(a31,K22);        # true
IsSubgroup(a31,K23);        # true
IsSubgroup(a31,K24);        # true
